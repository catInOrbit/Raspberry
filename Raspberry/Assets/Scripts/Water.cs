...
public class Water : MonoBehaviour {
    ...
    void Start()
    {
        ...
        this.transform.position = new Vector3(xTransform, yTransform, zTransform);
    }

    void Update()
    {
        //gameObject.GetComponent<BoxCollider2D>().size = new Vector2(width, (top - bottom));
        //gameObject.GetComponent<BuoyancyEffector2D>().surfaceLevel = gameObject.GetComponent<BoxCollider2D>().size.y / 2;
    }
